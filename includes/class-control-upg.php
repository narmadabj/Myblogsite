<?php
/**
 * Classs Aakriti_Personal_Blog_Control_Upg
 *
 * @package WordPress
 * @subpackage Aakriti
 * @since Aakriti Blog 1.0
 */

if ( ! class_exists( 'Aakriti_Personal_Blog_Control_Upg' ) ) :

	/**
	 * Klean_blog_Control_Upg class.
	 */
	class Aakriti_Personal_Blog_Control_Upg extends WP_Customize_Control {
		 ...
		 */
		public $type = 'aakriti-personal-blog-control';
		...
		public function __construct( WP_Customize_Manager $manager, $id, array $args ) {
			$this->button_text;
			$manager->register_control_type( 'Aakriti_Personal_Blog_Control_Upg' );
		...
		public function content_template() {
			?>
			<div class="aakriti-blog">
				<# if ( data.options ) { #>
					<ul class="aakriti-blog-features">
						...
						<# if ( data.button_text && data.button_url ) { #>
							...
							<# } #>
								...
								<# if ( data.explained_features.length > 0 ) { #>
									...
									<ul class="aakriti-blog-feature-list">
