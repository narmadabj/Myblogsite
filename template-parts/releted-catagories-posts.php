<?php
	...
	if( $query->have_posts() ) {
?>
<div class="aakriti-personal-blog-related-posts clearfix">
	<div class="aakriti-personal-blog-cat-posts">
		<h3><span><?php echo esc_html($related_post_title).' '. esc_html($cat_name); ?></span></h3>
			<div class="row">
				...
				?>
					<div class="aakriti-personal-blog-col-4 aakriti-personal-blog-columns">
						<div class="aakriti-personal-blog-related-posts-inner">
	...
	</div><!-- end .aakriti-personal-blog-cat-posts -->
</div><!-- end .aakriti-personal-blog-related-posts -->
<?php
